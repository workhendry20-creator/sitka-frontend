...
import { Star, Calendar, BookOpen, Heart } from 'lucide-react';
...
const DashboardOrtu = () => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700">
      {/* Welcome Card */}
      <div className="bg-[#0a1e36] p-8 rounded-[3rem] text-white relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {['Matematika', 'B. Indonesia', 'Agama', 'Seni Lukis'].map((mapel, i) => (
            <div key={i} className="p-6 bg-slate-50 rounded-[2rem] border border-slate-100 flex items-center justify-between">
              ...
              <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center text-[#306896] shadow-sm">
                <BookOpen size={20} />
              </div>
            </div>
          ))}
